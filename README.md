...
Coming next: carrying the client-name label through jobs and results (schema +
API + export), and the dashboard upload UI. Then deployment packaging for agents (Dockerfile, systemd unit, and a
